...
User-server의 구현, 운영, 문제 해결 문서는 이 디렉토리에서 관리합니다.
...
- [Platform 사용 기준](./platform.md): `platform-governance`, `audit-log`, runtime 관측 기준
...
계약이 바뀌면 contract repo의 User upstream OpenAPI를 먼저 갱신한 뒤, 이 파일을 같은 내용으로 맞춥니다.
